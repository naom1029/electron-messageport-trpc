...
|---|---|---|
| Topology | Star (main as hub) | Flexible (renderer-to-renderer, main-to-utility) |
...
In advanced topologies, the main process can broker ports between two renderers for direct peer-to-peer communication, or connect to utility processes.
